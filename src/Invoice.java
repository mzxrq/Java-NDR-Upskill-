 ...
 * Relationship: Composition with Customer.
 */
...
public class Invoice {
    ...
    public Invoice(int id, Customer customer, double amount) {
        if (id < 0) {
            throw new IllegalArgumentException("Invoice ID must be non-negative.");
        }
        if (customer == null) {
    ...
    // core business logic: apply customer's discount policy
    public double getAmountAfterDiscount() {
        return customer.getDiscountPolicy().applyDiscount(this.amount);
    }
